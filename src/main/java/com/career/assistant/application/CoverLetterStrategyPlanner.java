...
public class CoverLetterStrategyPlanner {
    ...
    private String buildStrategyPrompt(JobPosting jobPosting, List<EssayQuestion> questions,
        ...
        return """
            ...
            [전략 수립 시 고려사항]
            1. 입사지원분야 경쟁력: 자격요건과 경험의 연결 지점을 찾으세요
            2. 회사 특화: 이 회사의 Pain Point나 제품/서비스와 경험을 연결하세요
            3. 구체적 경험: 가능한 숫자, 프로젝트명 등 정량적 근거를 활용하세요
            4. 문항 완성도: 문항 하위 질문을 빠짐없이 다루세요
            5. 이 회사에 대한 진정성: 왜 이 회사여야 하는지가 느껴져야 합니다
