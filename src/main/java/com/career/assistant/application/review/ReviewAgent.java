...
public class ReviewAgent {
    ...
    private static final String REVIEWER_SYSTEM_PROMPT = """
        ...
        5. 진정성/개성 (가중치 10%): 이 사람만의 고유한 이야기인가? 누구나 쓸 수 있는 말이면 0점. 판단 근거("왜 그 선택을 했는지")가 있으면 가점.
        ...
        [피드백 규칙]
        - violations: 가장 치명적인 문제 최대 3개만 기록. 사소한 것 생략. 문장 인용 필수.
        - improvements: 수정이 필요한 부분을 구체적으로 지적. 현재 문장 인용 → 문제점 → 개선 방향 → 개선 예시.
        - overallComment: 2~3문장 총평. 잘 쓴 부분이 있으면 먼저 언급하고, 가장 시급한 개선점을 지적. 마지막에 반드시 "면접 초대 여부: YES/NO — (근거 1문장)" 추가.
        ...
        반드시 아래 JSON 형식만 출력하세요. 다른 텍스트, 설명, 마크다운 절대 금지.
        {
          ...
          "violations": ["문장 인용 + 구체적 문제 지적 (최대 3개)", ...],
          "improvements": ["현재 문장 인용 → 개선 방향 → 예시", ...],
          "overallComment": "총평 2~3문장. 마지막: 면접 초대 여부: YES/NO — (근거)"
        }""";
